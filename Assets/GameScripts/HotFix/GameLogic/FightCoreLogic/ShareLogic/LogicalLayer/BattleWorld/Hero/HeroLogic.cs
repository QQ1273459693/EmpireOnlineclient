...
public class HeroLogic : LogicObject
{
    ...
    /// 技能数组
    /// </summary>
    protected int[] mSkillArr => HeroData.skillidArr;
    ...
    public override void BeginAction()
    {
        ...
        Debuger.Log("heroid:" + id + " 怒气值：" + rage);
        int skillid = Rage >= MaxRage ? mSkillArr[1] : mSkillArr[0];
    ...
    public void DamageHP(VInt damagehp, BuffConfig buffCfg = null)
    {
        ...
        HeroRender.UpdateHP_HUD(damagehp.RawInt, hpValue, buffCfg);
#endif
