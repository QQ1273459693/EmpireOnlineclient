...
#endif
{
    ...
    [LabelText("触发伤害类型")]
    public BuffTriggerDamageType buffTriggerDamageType;     //触发方式
    [LabelText("伤害方式")]
...
//Buff触发伤害类型
public enum BuffTriggerDamageType
{
...
{
    [LabelText("攻击时触发")] None,
    [LabelText("回合开始时伤害")] Damage_RoundStart,                   //回合开始时伤害
    [LabelText("回合结束时伤害")] Damage_ActionEnd,                    //回合结束时伤害
}
