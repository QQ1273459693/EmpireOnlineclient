...
public class ScalableBlur : IBlurAlgorithm
{
    ...
    readonly RenderTargetIdentifier[] scratches = new RenderTargetIdentifier[8];
    ...
    )
    {
        ...
        var depth = Mathf.Min(config.Iteration - 1, 7);
    ...
    {
        return Mathf.Min(config.Iteration, 8);
    }
