...
namespace LeafUtilsRays
{
    ...
    {
        public static void Banner(Texture banner)
        {
            Rect rect; 
            Rect vrect;
        ...
        public static void MinMaxSliderCryo(string label, ref Cryo<float> left,ref Cryo<float> right, float leftMin, float leftMax )
        {
            float l = left.value;
            float r = right.value;
            EditorGUILayout.MinMaxSlider(label, ref l, ref r, leftMin,leftMax);
            if (left.value != l) left.onValueChanged.Invoke();
            if (right.value != r) right.onValueChanged.Invoke();
            left.value = l;
            right.value = r;
        }
        ...
        public static GUIStyle Text(Color color, int fontsize = 18, FontStyle style = FontStyle.Normal, TextAnchor aligement = TextAnchor.MiddleLeft) 
        {
            GUIStyle text = new GUIStyle();
            text.fontSize = fontsize;
            text.fontStyle = style;
            text.alignment = aligement;
        ...
        public static GUIStyle Header(int fontsize = 18, TextAnchor anchor = TextAnchor.MiddleCenter, string color = "EDAE49", Font f = null)
        {
