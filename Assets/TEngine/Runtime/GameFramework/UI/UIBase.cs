...
namespace TEngine
{
    ...
    public class UIBase : IUIBehaviour
    {
        ...
        protected static void RegisterEventClick(GameObject go,UIEventHandle<PointerEventData> handle)
        {
            ...
            EventTriggerListener.Get(go).onClick.AddListener(handle);
        }
        protected static void RegisterEventClickDouble(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onDoubleClick.AddListener(handle);
        }
        protected static void RegisterEventClickDown(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onDown.AddListener(handle);
        }
        protected static void RegisterEventClickUp(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onUp.AddListener(handle);
        }
        protected static void RegisterEventClickEnter(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onEnter.AddListener(handle);
        }
        protected static void RegisterEventClickExit(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onExit.AddListener(handle);
        }
        protected static void RegisterEventPress(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onPress.AddListener(handle);
        }
        protected static void RegisterEventLongPress(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onLongPress.AddListener(handle);
        }
        protected static void RegisterEventContinuousPress(GameObject go, UIEventHandle<PointerEventData> handle)
        {
            if (null == go || null == handle)
                return;

            EventTriggerListener.Get(go).onContinuousPress.AddListener(handle);
        }
        #endregion
